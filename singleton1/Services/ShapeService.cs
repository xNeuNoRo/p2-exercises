...
public class ShapeService
{
    public BaseShape Create(int id, ShapeType type)
    {
        ...
        return type switch
        {
            ...
            ShapeType.Triangle => HandleCreateSingletonTriangle(id, color),
            ShapeType.Square => HandleCreateSquare(id, color),
    ...
    public Triangle HandleCreateSingletonTriangle(int id, string color)
    {
    ...
    public Square HandleCreateSquare(int id, string color)
    {
