...
import { IoPerson, IoPaw, IoClose, IoCodeSlash } from "react-icons/io5";

const navItems = [
  { name: "Mi Perfil", href: "/", icon: IoPerson },
  { name: "Mascotas", href: "/pets", icon: IoPaw },
];
    ...
    <>
      ...
      <aside
        className={classNames(
          ...
          "fixed left-0 top-0 z-40 h-screen w-64 border-r border-gray-200 bg-white transition-transform duration-300 ease-in-out sm:translate-x-0",
        )}
      >
        <div className="flex h-full flex-col px-3 py-8">
          ...
          <div className="border-t border-gray-200 pt-4 mt-auto">
            <a
              ...
              className="group flex w-full items-center gap-3 rounded-xl p-3 text-left transition-all hover:bg-gray-50"
            >
              {/* Icono del footer */}
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-gray-100 text-blue-600 transition-colors group-hover:bg-blue-600 group-hover:text-white">
